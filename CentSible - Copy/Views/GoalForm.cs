...
namespace CentSible.Views
{
    public partial class GoalForm : Form
    {
        ...
        private void SidebarTableLayoutGoal_Paint(object sender, PaintEventArgs e)
        {

        }

        private void CurrentAmountLabelGoal_Click(object sender, EventArgs e)
        {

        }

        private void TargetAmountLabelGoal_Click(object sender, EventArgs e)
        {
